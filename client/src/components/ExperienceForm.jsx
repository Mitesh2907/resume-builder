            ...
            {data.map((experience, index)=>(
                <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                    ...
                    <div className='grid md:grid-cols-2 gap-3'>
                        ...
                        <input value={experience.start_date || ""} type="month"
                        onChange={(e)=>updateExperience(index, "start_date", e.target.value)}
                        className='px-3 py-2 text-sm rounded-lg' />

                        <input value={experience.end_date || ""} type="month"
                    ...
                    <div className='space-y-2'>
                        <div className='flex items-center justify-between'>
                            ...
                            <button onClick={()=> generatingDescription(index)} disabled={generatingIndex === index || !experience.position || !experience.company}
                        ...
                        placeholder='Description your key responsibilities and achievements...' />
                    </div>
                </div>
            ))}
        </div>
