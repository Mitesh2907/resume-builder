...
const ResumeBuilder = () => {
  ...
  const handleShare = () => {
    ...
    if(navigator.share){
      ...
      alert('Share not suppoted on this browser.')
    }
  }
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1 relative">
              ...
              <button onClick={()=> {toast.promise(saveResume, {loading: 'Saving...'})}} className='bg-linear-to-br from-green-100 to-green-200
              ring-green-300 text-green-600 ring hover:ring-green-400 transition-all
          ...
          <div className="lg:col-span-7 max-lg:mt-6">
            <div className='relative w-full'>
                ...
                justify-end gap-2'>
                  ...
                  <button onClick={downloadResume} className='flex items-center py-2 px-6 gap-2 text-xs
